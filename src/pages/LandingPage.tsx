...
const LandingPage: React.FC = () => {
  ...
  const animatedTexts = ['Planos de Aula', 'Slides', 'Atividades', 'Avaliações'];
  ...
  const plans: Plan[] = [{
    ...
    features: ['5 materiais por mês', 'Download em PDF', 'Suporte básico', 'Acesso aos templates básicos'],
    materialTypes: ['Planos de Aula básicos', 'Atividades simples'],
    limitations: ['Sem download em Word/PPT', '5 materiais por mês', 'Sem edição avançada', 'Sem Slides Interativos', 'Sem Avaliações Personalizadas', 'Sem acesso ao Calendário de aulas'],
    highlight: false,
    ...
    features: ['50 materiais por mês', 'Download em PDF, Word e PPT', 'Edição completa de materiais', 'Todos os templates disponíveis', 'Suporte por e-mail', 'Calendário de aulas', 'Histórico completo'],
    materialTypes: ['Planos de Aula completos', 'Slides interativos', 'Atividades diversificadas', 'Avaliações personalizadas'],
    limitations: [],
    highlight: true,
  ...
  const materialTypes = [{
    name: 'Planos de Aula',
    icon: <NotebookPen className="w-8 h-8 md:w-12 md:h-12" />,
    // Livro com caneta
    ...
    icon: <FileSignature className="w-8 h-8 md:w-12 md:h-12" />,
    // Livro com caneta/atividade
    description: 'Exercícios diversificados para praticar, revisar e fixar conteúdos com sua turma de forma eficaz.',
    color: 'from-green-500 to-green-600',
    bgColor: 'bg-green-50'
  }, {
    name: 'Avaliações',
    icon: <FileCheck2 className="w-8 h-8 md:w-12 md:h-12" />,
    // Checklist/prova
  ...
  return <div className="min-h-screen bg-white">
            ...
            {isMobile ? <div className="flex items-center w-full justify-between relative">
                ...
                <BookOpen className="w-6 h-6" />
                  ...
                  <div className="flex flex-col justify-center">
                    <span className="logo-text text-2xl text-primary-600" style={{
                  fontWeight: 400
                }}>AulagIA</span>
                ...
                <div className="relative">
                  ...
                  {showMobileMenu && <div className="fixed left-0 right-0 top-[64px] w-full bg-white shadow-xl rounded-b-2xl border-b border-gray-100 z-50 animate-fade-in flex flex-col items-center px-6 py-6 gap-6" style={{
                minWidth: 220
              }}>
                      ...
                      <div className="flex flex-col gap-3 w-full max-w-xs mx-auto mt-6">
                        <Button size="lg" className="bg-gradient-to-r from-primary-500 to-secondary-500 text-white text-lg font-semibold shadow-md w-full" onClick={() => {
                    setShowMobileMenu(false);
                    document.getElementById('planos')?.scrollIntoView({
                      behavior: 'smooth'
                    });
                  }}>Começar Gratuitamente</Button>
                        <Button size="lg" variant="outline" className="border-primary-500 text-primary-600 text-lg font-semibold w-full" onClick={() => {
                    setShowMobileMenu(false);
                    navigate('/login');
                  }}>Entrar Agora</Button>
                      </div>
          ...
          <div className="animate-fade-in">
            ...
            <p className="text-base md:text-lg text-gray-600 mb-8 leading-relaxed max-w-xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8 justify-center lg:justify-start">
                <Button size="lg" onClick={() => document.getElementById('planos')?.scrollIntoView({
              behavior: 'smooth'
            })} className="bg-gradient-to-r from-primary-500 to-secondary-500 hover:scale-105 transition-all text-lg px-8 py-3">
                  Começar Gratuitamente
                  <ArrowRight className="ml-2 w-5 h-5" />
                </Button>
                <Button variant="outline" size="lg" onClick={() => document.getElementById('exemplos')?.scrollIntoView({
              behavior: 'smooth'
      ...
      <section id="recursos" className="py-12 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            {materialTypes.map((type, index) => <Card key={type.name} className={`group hover:shadow-xl transition-all duration-300 hover:-translate-y-2 ${type.bgColor} border-0 animate-fade-in`} style={{
      ...
      <section id="exemplos" className="py-12 md:py-20 bg-gradient-to-br from-gray-50 to-primary-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12">
            ...
            <div className="animate-fade-in">
              <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div className="p-4 md:p-6">
                  <img src="/lovable-uploads/8d8c57d9-c003-47e7-a99b-66b9dcd5c539.png" alt="Exemplo de slide sobre formas geométricas" className="w-full rounded-lg shadow-md" />
                  <div className="mt-4">
            ...
            <div className="animate-fade-in animation-delay-300">
              <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div className="p-4 md:p-6">
                  <img src="/lovable-uploads/19d67dd7-a768-49dd-a633-506c212567d6.png" alt="Exemplo de plano de aula sobre multiplicação" className="w-full rounded-lg shadow-md" />
                  <div className="mt-4">
          ...
          <div className="text-center mt-8 md:mt-12">
            <Button size="lg" onClick={() => navigate('/login')} className="bg-gradient-to-r from-primary-500 to-secondary-500 hover:scale-105 transition-all text-lg px-8 py-3">
      ...
      <section id="beneficios" className="py-12 md:py-20 bg-gradient-to-br from-primary-50 to-secondary-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {benefits.map((benefit, index) => <Card key={benefit.title} className="bg-white hover:shadow-lg transition-all duration-300 animate-fade-in" style={{
            animationDelay: `${index * 100}ms`
          }}>
      ...
      <section className="py-12 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {testimonials.map((testimonial, index) => <Card key={testimonial.name} className="bg-gray-50 hover:shadow-lg transition-all duration-300 animate-fade-in" style={{
            animationDelay: `${index * 100}ms`
          }}>
                <CardContent className="p-4 md:p-6">
                  <div className="flex mb-4">
                    {[...Array(testimonial.rating)].map((_, i) => <Star key={i} className="w-4 h-4 md:w-5 md:h-5 fill-yellow-400 text-yellow-400" />)}
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16">
            ...
            <div className="inline-flex items-center bg-white rounded-full p-1 shadow-md">
              <button onClick={() => setBillingCycle('monthly')} className={`px-4 md:px-6 py-2 rounded-full text-sm md:text-base font-medium transition-all ${billingCycle === 'monthly' ? 'bg-primary-500 text-white shadow-sm' : 'text-gray-600 hover:text-gray-900'}`}>
                Mensal
              </button>
              <button onClick={() => setBillingCycle('yearly')} className={`px-4 md:px-6 py-2 rounded-full text-sm md:text-base font-medium transition-all ${billingCycle === 'yearly' ? 'bg-primary-500 text-white shadow-sm' : 'text-gray-600 hover:text-gray-900'}`}>
                Anual
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8 max-w-6xl mx-auto">
            {plans.map((plan, index) => <Card key={plan.name} className={`relative flex flex-col transition-all duration-300 hover:shadow-xl rounded-xl p-4 md:p-6 ${plan.highlight ? 'ring-2 ring-blue-500 lg:scale-105 border-2 border-blue-200' : plan.name === 'Professor' ? 'ring-2 ring-green-500 border-2 border-green-500 bg-green-50' : 'border-2 border-gray-200'}`} style={{
            animationDelay: `${index * 100}ms`,
            height: '100%',
            maxHeight: 'none',
            overflow: 'visible'
          }}>
                {plan.popular && plan.name !== 'Professor' && typeof plan.name === 'string' && <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                    <Badge className="bg-blue-500 text-white px-3 md:px-4 py-1 text-xs">POPULAR</Badge>
                  </div>}
                {plan.name === 'Professor' && <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                ...
                <div className="mb-6">
                  ...
                  {billingCycle === 'yearly' && (plan.id === 'professor' || plan.id === 'grupo-escolar') && <div className="mt-1 flex items-center gap-2">
                ...
                {/* Tipos de Materiais */}
                {plan.materialTypes.length > 0 && <div className="mb-4">
                  ...
                  <div className="space-y-2">
                      {plan.materialTypes.map((type, idx) => <div key={idx} className="flex items-start">
                ...
                {plan.id === 'grupo-escolar' && <div className="mb-4">
                ...
                <ul className="space-y-2 md:space-y-3 mb-6 flex-1">
                  ...
                  {plan.limitations && plan.limitations.map((limitation, idx) => <li key={idx} className="flex items-start">
      ...
      <section className="py-12 md:py-20 bg-gradient-to-r from-primary-500 to-secondary-500 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" variant="secondary" onClick={() => navigate('/login')} className="bg-white text-primary-600 hover:bg-gray-50 text-lg px-8 py-3">
              Criar Conta Grátis
              <ArrowRight className="ml-2 w-5 h-5" />
            </Button>
          </div>
            ...
            <div className="col-span-2 md:col-span-1">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div className="flex flex-col">
                  <span className="logo-text text-2xl text-[#19a7f6] leading-tight" style={{
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <Button size="lg" onClick={() => navigate('/login')} className="bg-gradient-to-r from-primary-500 to-secondary-500 hover:scale-110 transition-all shadow-lg rounded-full px-6 py-3 text-base md:text-lg">
          Começar Grátis
          <ArrowRight className="ml-2 w-5 h-5" />
        </Button>
      </div>
